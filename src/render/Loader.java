...
public class Loader
{
			...
			float[] vertexWeights)
	{
		...
		{
			//Ledd-id mÃ¥ lagres som intArray
	...
	private void storeDataInAttributeList(int attributeNumber, int coordinateSize, float[] data,boolean storeInIntBuffer){
		...
		// Binder VBOen for ï¿½ kunne gjï¿½re noe med den. (aktivere den)
		...
		// Legger VBOen inn i VAOen. Attributtnummer hvor du vil lagre det - lengde pï¿½ hver vertex - type data - normalized? - distanse mellom vertexene (noen data i mellom)
